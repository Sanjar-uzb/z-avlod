    ...
    return (
      <div className="container">
        <div className="card">
          ...
          <Link className="btn btnGhost" href="/methods">
            Orqaga
          </Link>
        </div>
      </div>
  ...
  return (
    <div className="container">
      <div className="card">
        ...
        <ul>
          {method.reflectionPrompts.map((r, i) => (
            <li key={i} style={{ marginBottom: 6 }}>
              {r}
            </li>
          ))}
        ...
        <div style={{ marginTop: 12 }}>
          ...
          <div className="row" style={{ marginTop: 10 }}>
            <button className="btn" onClick={saveReflection}>
              Refleksiyani saqlash
            </button>
            <Link className="btn btnGhost" href="/reflections">
              Refleksiyalarni ko‘rish
            </Link>
            {quiz && (
              <Link className="btn btnGhost" href={`/quiz?id=${quiz.id}`}>
                Mini-quiz
              </Link>
            )}
          </div>
