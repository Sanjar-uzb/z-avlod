  ...
  return (
    <div className="container">
      <div className="card hero">
        ...
        <p className="muted">
          Bu bo‘limda jami {list.length} ta savol bor. Test boshlanganda shu bankdan
          ixtiyoriy {Math.min(QUIZ_SIZE, list.length)} ta savol tanlanadi. Har bir savol
          tezkor fikrlashni, diqqatni jamlashni va mavzuni mustahkamlashni rivojlantiradi.
        </p>
        ...
        <div className="row" style={{ marginTop: 10 }}>
          ...
          >
            Boshlash ({Math.min(QUIZ_SIZE, list.length)} savol)
          </Link>
        </div>
      </div>
