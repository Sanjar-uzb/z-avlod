    ...
    <div className="container">
      ...
      <section className="card hero">
        ...
        <p className="heroSubtitle">
          Ushbu platforma Z avlod o‘quvchilarining raqamli muhitdagi ehtiyojlariga mos
          metodlarni jamlaydi: shaxsga yo‘naltirilgan yondashuv, kompetensiyaviy ta’lim,
          loyiha va keyslar, gamifikatsiya, interaktiv hamda adaptiv metodlar.
        </p>
      ...
      <section className="grid" style={{ marginTop: 14 }}>
        <div className="card" style={{ gridColumn: "span 6" }}>
          ...
          <p className="muted">
            Z avlod vakillari bilan ishlashda zamonaviy ta’lim va tarbiya metodlarini
            platforma ko‘rinishida tizimlashtirish hamda amaliy qo‘llash mexanizmini ko‘rsatish.
          </p>
        ...
        <div className="card" style={{ gridColumn: "span 6" }}>
          ...
          <div className="moduleList">
            <div className="module">
              ...
              <div className="muted">8 ta metod bo‘limi: shaxsga yo‘naltirilgan, kompetensiya, loyiha, keys, gamifikatsiya, raqamli ta’lim, interaktiv, adaptiv.</div>
            </div>
      ...
      {/* METHODOLOGY / RESULTS EXPECTED */}
      <section className="grid" style={{ marginTop: 14 }}>
        <div className="card" style={{ gridColumn: "span 7" }}>
          <div className="h2">Metodologik yondashuv</div>
          <p className="muted">
            Platforma metodlar katalogi, interaktiv topshiriqlar va refleksiya orqali
            o‘quvchi faolligini oshirish, tezkor feedback berish hamda o‘z-o‘zini baholash
            elementlarini kuchaytirishga xizmat qiladi.
          </p>
